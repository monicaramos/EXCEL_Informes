...
'NombreHoja = Command '"/E|ariagro8|22000|L1"
NombreHoja = "/E|ariagro8|22000|L1"
...
If Mid(NombreHoja, 1, 1) = "C" Then
    EsImportaci = 0
Else
    If Mid(NombreHoja, 1, 1) = "I" Then
        EsImportaci = 1
    Else
        EsImportaci = 2
    End If
